...
--
-- Host: 127.0.0.1
-- Generation Time: 23 พ.ค. 2020 เมื่อ 12:18 PM
...
CREATE TABLE `borrows` (
  ...
  `date` date NOT NULL,
  `campaign_code` varchar(8) NOT NULL,
  `borrow_code` varchar(11) NOT NULL,
  `education` int(1) NOT NULL,
  `family_status` int(1) NOT NULL,
  `spouse_prefix` varchar(10) NOT NULL,
  `spouse_firstname` varchar(32) NOT NULL,
  `spouse_lastname` varchar(32) NOT NULL,
  `spouse_mobile` varchar(20) NOT NULL,
  `spouse_career` varchar(255) NOT NULL,
  `spouse_children` int(11) NOT NULL,
  `spouse_income` float(11,2) NOT NULL,
  `address_number` varchar(7) NOT NULL,
  `address_room` varchar(5) NOT NULL,
  `address_soi` varchar(32) NOT NULL,
  `address_street` varchar(32) NOT NULL,
  `address_district` varchar(32) NOT NULL,
  `address_amphur` varchar(32) NOT NULL,
  `address_province` int(2) NOT NULL,
  ...
  `address_hire` float(11,2) NOT NULL,
  `address_month` int(2) NOT NULL,
  `address_year` int(4) NOT NULL,
  `address_person` int(2) NOT NULL,
  `work_company` varchar(255) NOT NULL,
  `work_status` varchar(255) NOT NULL,
  `work_position` varchar(32) NOT NULL,
  `work_department` varchar(32) NOT NULL,
  `work_income` float(11,2) NOT NULL,
  `work_income_etc` float(11,2) NOT NULL,
  `work_income_source` varchar(32) NOT NULL,
  `work_addr_number` varchar(7) NOT NULL,
  `work_addr_build` varchar(32) NOT NULL,
  `work_addr_floor` int(2) NOT NULL,
  `work_addr_code` varchar(10) NOT NULL,
  `work_addr_soi` varchar(32) NOT NULL,
  `work_addr_street` varchar(32) NOT NULL,
  `work_addr_district` varchar(32) NOT NULL,
  `work_addr_amphur` varchar(32) NOT NULL,
  `work_addr_province` int(2) NOT NULL,
  `work_addr_zipcode` int(5) NOT NULL,
  `work_addr_phone` varchar(12) NOT NULL,
  `work_addr_mobile` varchar(10) NOT NULL,
  `work_addr_fax` varchar(12) NOT NULL,
  `work_old_year` int(4) NOT NULL,
  `work_old_month` int(2) NOT NULL,
  `doc_address` int(1) NOT NULL,
  `doc_addr_number` varchar(7) NOT NULL,
  `doc_addr_room` varchar(10) NOT NULL,
  `doc_addr_soi` varchar(32) NOT NULL,
  `doc_addr_street` varchar(32) NOT NULL,
  `doc_addr_district` varchar(32) NOT NULL,
  `doc_addr_amphur` varchar(32) NOT NULL,
  `doc_addr_province` int(2) NOT NULL,
  `doc_addr_zipcode` int(5) NOT NULL,
  `objective_company` varchar(255) NOT NULL,
  `objective_program` varchar(255) NOT NULL,
  `objective_price` float(11,2) NOT NULL,
  `objective_duration` int(1) NOT NULL,
  `person_prefix` varchar(7) NOT NULL,
  `person_firstname` varchar(32) NOT NULL,
  `person_lastname` varchar(32) NOT NULL,
  `person_phone` varchar(15) NOT NULL,
  `person_relationship` varchar(32) NOT NULL,
  `person_prefix2` varchar(7) NOT NULL,
  `person_firstname2` varchar(32) NOT NULL,
...
CREATE TABLE `customers` (
  ...
  `idcard_expire` date DEFAULT NULL,
...
INSERT INTO `customers` (`id`, `code`, `idcard`, `birthday`, `prefix_name`, `first_name`, `last_name`, `idcard_expire`, `sex`, `created_at`, `updated_at`) VALUES
...
--
-- dump ตาราง `system_info`
--

INSERT INTO `system_info` (`option_name`, `option_value`) VALUES
('title', 'Cooperative Education Center'),
('name', 'ศูนย์สหกิจศึกษา มหาวิทยาลัยราชภัฏลำปาง'),
('location_address', 'ชั้น 4 อาคาร 38 ตึกโอฬาร \r\nมหาวิทยาลัยราชภัฏลำปาง 119 หมู่ 9 ถนนลำปาง-แม่ทะ ต.ชมพู อ.เมือง'),
('location_zip', '52100'),
('location_city', '40'),
('font', '2'),
('phone', '054-237399 ต่อ (6000)'),
('facebook_id', 'cooplpru'),
('workingtime', 'จ. - ศ. 08.00 - 17.30 (เว้นวันหยุดราชการ)'),
('corp_start_date', '2018-07-01'),
('corp_end_date', '2018-11-01'),
('google_analytic', 'close'),
('reg_student', 'waiting'),
('reg_corp', 'waiting'),
('website_status', 'open');
